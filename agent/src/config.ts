...
ZEROG_COMPUTE_MODEL: process.env.ZEROG_COMPUTE_MODEL ?? "qwen/qwen-2.5-7b-instruct",
  ...
  // 0G Storage (testnet)
  ZEROG_STORAGE_RPC: process.env.ZEROG_STORAGE_RPC ?? "https://evmrpc-testnet.0g.ai",
  ZEROG_STORAGE_INDEXER: process.env.ZEROG_STORAGE_INDEXER ?? "https://indexer-storage-testnet-turbo.0g.ai",
  ZEROG_STORAGE_PRIVATE_KEY: process.env.ZEROG_STORAGE_PRIVATE_KEY,
